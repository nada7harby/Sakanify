                      ...
                      {[...Array(5)].map((star, index) => {
                        ...
                        return (
                          <FontAwesomeIcon
                            ...
                            className={
                              index <= rating ? "star selected" : "star"
                            }
                          />
                        );
                      })}
                      ...
                      {[...Array(5)].map((star, index) => {
                        ...
                        return (
                          <FontAwesomeIcon
                            ...
                            className={
                              index <= rating2 ? "star selected" : "star"
                            }
                          />
                        );
                      })}
                      ...
                      {[...Array(5)].map((star, index) => {
                        ...
                        return (
                          <FontAwesomeIcon
                            ...
                            className={
                              index <= rating3 ? "star selected" : "star"
                            }
                          />
                        );
                      })}
                      ...
                      {[...Array(5)].map((star, index) => {
                        ...
                        return (
                          <FontAwesomeIcon
                            ...
                            className={
                              index <= rating4 ? "star selected" : "star"
                            }
                          />
                        );
                      })}
            ...
            <Col sm={12} className="mt-3 mb-5">
              <div>
                <div className="d-flex justify-content-center">
                  ...
                  />
                  <h2 className="RoomDetailsRate2">
                    {RoomData.ratingsAverage}
                  </h2>
